...
\par Les commandes reprises ici (et dans plein de documentation sur internet) sont divisées en deux catégories, les commandes exécutées par un utilisateur normal et celles exécutées par root. Les commandes normales sont précédées du symbole \$, les commandes root d'un \#.\\
Exemple:
