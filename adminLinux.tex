...
\par Notons que la commande "mount" peut également vous servir à lister tous les "trucs" monté sur le système (partition, montage réseau, etc ...). (\textbf{\#HINT \#EXAMEN})
